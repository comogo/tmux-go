...
//
//    assert.Includes(someSlice, "Foo", "But ["Foo", "Bar"] does include 'Foo'")
//
// Returns whether the assertion was successful (true) or not (false).
func (a *Assertions) Includes(list, element interface{}, msgAndArgs ...interface{}) bool {
	return Includes(a.t, list, element, msgAndArgs...)
}

// NotIncludes asserts that the specified iterable does NOT contain the specified element.
//
//    assert.NotIncludes(someSlice, "Foo", "But '["Foo", "Bar"]' does NOT include 'Baz'")
//
// Returns whether the assertion was successful (true) or not (false).
func (a *Assertions) NotIncludes(list, element interface{}, msgAndArgs ...interface{}) bool {
	return NotIncludes(a.t, list, element, msgAndArgs...)
}
